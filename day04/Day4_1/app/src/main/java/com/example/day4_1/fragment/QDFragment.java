...
import com.example.day4_1.adapter.MyJinYanRecAdapter1;
import com.example.day4_1.adapter.MyJinYanRecAdapter2;
...
public class QDFragment extends Fragment {
        ...
        private MyJinYanRecAdapter2 myPaoZiRecAdapter2;
        @Override
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
                                 Bundle savedInstanceState) {
            view = inflater.inflate(R.layout.fragment_t_h, container, false);
            initView();
            initData();
            return view;
        }
            ...
            new Retrofit.Builder()
                    ...
                    .subscribe(new Observer<PaoZiBean>() {
                        ...
                        public void onNext(PaoZiBean value) {
                            ...
                            list.addAll(data);
                            myPaoZiRecAdapter2.notifyDataSetChanged();
        ...
        private void initView() {
            ...
            myPaoZiRecAdapter2 = new MyJinYanRecAdapter2(getActivity(), list);

            rec.setAdapter(myPaoZiRecAdapter2);
