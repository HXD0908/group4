...
public class MyJinYanRecAdapter extends RecyclerView.Adapter {

    private Activity context;
    private ArrayList<PaoZiBean.DataBean> list;

    public MyJinYanRecAdapter(Activity context, ArrayList<PaoZiBean.DataBean> list) {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        viewHolder.jinyan.setText("                                                            "+list.get(position).getUserID()+"经验");
