...
public class MyJinYanRecAdapter2 extends RecyclerView.Adapter {

    private Activity context;
    private ArrayList<PaoZiBean.DataBean> list;

    public MyJinYanRecAdapter2(Activity context, ArrayList<PaoZiBean.DataBean> list) {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        viewHolder.jinyan.setText("                                                      连续签到"+list.get(position).getUserID()+"天");
