...
public class LevelAdapter extends RecyclerView.Adapter {
    ...
    public LevelAdapter(Context context, ArrayList<LevelBean.DataBean.ExpTopBean.ListBean> levelBeans) {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        LevelBean.DataBean.ExpTopBean.ListBean bean = levelBeans.get(position);
