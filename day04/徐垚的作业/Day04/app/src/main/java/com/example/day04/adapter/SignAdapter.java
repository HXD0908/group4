...
public class SignAdapter extends RecyclerView.Adapter {
    ...
    public SignAdapter(Context context, ArrayList<SignBean.DataBean.SignTopBean.ListBean> signBeans) {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        SignBean.DataBean.SignTopBean.ListBean bean = signBeans.get(position);
