...
public class THFragment extends Fragment {
    ...
    private MyJinYanRecAdapter1 myPaoZiRecAdapter1;
    @Override
        ...
        new Retrofit.Builder()
                ...
                .subscribe(new Observer<PaoZiBean>() {
                    ...
                    public void onNext(PaoZiBean value) {
                        ...
                        list.addAll(data);
                        myPaoZiRecAdapter1.notifyDataSetChanged();
    ...
    private void initView() {
        ...
        myPaoZiRecAdapter1 = new MyJinYanRecAdapter1(getActivity(), list);

        rec.setAdapter(myPaoZiRecAdapter1);
